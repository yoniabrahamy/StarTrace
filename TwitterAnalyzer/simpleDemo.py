...
#Read the tweets one by one and process it, here you can change the data-source for the test
...
#This part is about svm classifer, it is IRRELEVANT at the moment
'''
